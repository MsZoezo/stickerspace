...
const Header = () => {
    return(
        <header className="header">
            <figure className="header__stickers"><img src="/images/Stickers.svg" alt="Stickers" /></figure>
